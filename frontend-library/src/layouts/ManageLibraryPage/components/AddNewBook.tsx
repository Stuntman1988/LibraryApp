...
import {AddBookRequest} from "../../../models/AddBookRequest.ts";
...
export const AddNewBook = () => {
    ...
    async function submitNewBook() {
        ...
        if (isAuth && title !== '' && author !== '' && category !== 'Category' && description !== '' && copies >= 0) {
            ...
            const submitNewBookResponse = await fetch(url, headersOptions)
                        ...
                        <div className="row">
                            ...
                            <div className="col-md-3 mb-3">
                                ...
                                <ul id="addNewBookId" className="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                    <li><a onClick={() => categoryField("FE")} className="dropdown-item">FrontEnd</a>
                                    </li>
                                    <li><a onClick={() => categoryField("BE")} className="dropdown-item">BackEnd</a>
                                    </li>
