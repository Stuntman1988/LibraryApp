...
import {LeaveAReview} from "../Utils/LeaveAReview.tsx";


export const CheckoutAndReviewBox: React.FC<{
    book: BookModel | undefined,
    mobile: boolean, currentLoansCount: number,
    isAuth: any, isCheckedOut: boolean,
    checkoutBook: any,
    ...
    function reviewRender() {
        if (props.isAuth && !props.isReviewLeft) {
            return (<div><LeaveAReview submitReview={props.submitReview}/></div>)
        } else if (props.isAuth && props.isReviewLeft) {
            return (<p><b>Thank you for your review!</b></p>)
        }

        return (<div>
            <hr/>
            <p>Sign in to be able to leave a review.</p></div>)
    }
