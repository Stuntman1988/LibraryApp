...
export const BookCheckoutPage = () => {
    ...
    useEffect(() => {
        const fetchUserReviewBook = async () => {
            if (isAuth) {
                ...
                const userReview = await fetch(url, headersOptions)
    ...
    useEffect(() => {
        const fetchUserCurrentLoansCount = async () => {
            if (isAuth) {
                ...
                const currentLoansCountResponse = await fetch(url, headersOptions)
    ...
    useEffect(() => {
        const fetchUserCheckedOutBook = async () => {
            if (isAuth) {
                ...
                const bookCheckedOut = await fetch(url, headersOptions)
    ...
    async function checkoutBook() {
        ...
        const checkoutResponse = await fetch(url, headersOptions)
