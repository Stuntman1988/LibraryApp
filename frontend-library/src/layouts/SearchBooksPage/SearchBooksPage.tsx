...
export const SearchBooksPage = () => {
    ...
    const searchHandleChange = () => {
        ...
        if (search === '') {
            ...
            setSearchUrl(`/search/findByTitleContaining?title=${search}&page=<pageNumber>&${booksPerPage}`)
        }
    ...
    const categoryField = (value: string) => {
        ...
        if(
            ...
            switch (value.toLowerCase()) {
                case 'fe': 
                setCategorySelection('Front End')
                break
                case 'be': 
                setCategorySelection('Back End')
                break
                case 'data': 
            ...
            <div className="container">
                <div>
                    ...
                    {totalAmountsOfBooks > 0 ?
                        <>
                            <div className="mt-3">
                                <h5>Number of results: ({totalAmountsOfBooks})</h5>
                            </div>
                            <p>
                        ...
                        <div className="m-5">
                            ...
                            <a className="btn main-color btn-md px-4 me-md-2 fw-bold text-white" href="#">Library Services</a>
                        </div>
                    }
